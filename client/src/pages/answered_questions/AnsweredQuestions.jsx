...
function AnsweredQuestions() {
	...
	const fetchAnsweredQuestionsID = async () => {
	...
	return (
		<div className="answered-qs-div container-fluid">

			<h1 style={{margin : "1rem"}}>Answered Questions</h1>
			<ToastContainer />

			<div>

				<div className="answered-qs-page-feed-div">

					<div className="answered-qs-page-feed-options-div w-75">
